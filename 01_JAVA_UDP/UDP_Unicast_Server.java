...
public class UDP_Unicast_Server {
	...
	// porta nel range consentito 1024-65535 dichiarata come statica perchè caratterizza il server
		...
		try {
			...
			while (true) {
				...
				try {
					...
					doStream.writeUTF(received + " " + received);
					...
					socket.send(packet);
					System.out.println("Sent: " + received + " " + received);
				} catch (IOException e) {
